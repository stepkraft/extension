...
const otherBonuses = [
    { logo: 'https://www.shareicon.net/data/512x512/2017/06/08/886802_logo_512x512.png', text: '5% cashback', url: 'https://taobao.com/' },
];
    ...
    return (
      <Container>
        <List divided relaxed>
          <List.Item>
            <Image avatar src='https://cdn.iconscout.com/icon/free/png-512/aliexpress-569572.png' />
            <List.Content>
